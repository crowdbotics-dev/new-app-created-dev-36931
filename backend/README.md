...
## Project Structure
    ...
    ├── new_app_created_dev_36931  # Django project configurations
...
1. Clone this repo and `cd new_app_created_dev_36931`
...
2. Clone this repo and `cd new_app_created_dev_36931`
